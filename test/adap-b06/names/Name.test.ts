...
describe("Delimiter function tests StringName", () => {
  it("test insert", () => {
    let n: Name = new StringName("oss#fau#de", '#');
    let n2: Name = n.insert(1, "cs");
    expect(n.asString()).toBe("oss#fau#de");
...
describe("Delimiter function tests StringArrayName", () => {
  it("test insert", () => {
    let n: Name = new StringArrayName(["oss#fau#de"], '#');
    let n2: Name = n.insert(1, "cs");
    expect(n.asString()).toBe("oss#fau#de");
...
describe("Escape character extravaganza StringName", () => {
  it("test escape and delimiter boundary conditions", () => {
    let n: Name = new StringName("oss.cs.fau.de", '#');
    expect(n.getNoComponents()).toBe(1);
    expect(n.asString()).toBe("oss.cs.fau.de");
    let n2: Name = n.append("people");
    expect(n.asString()).toBe("oss.cs.fau.de");
    expect(n2.asString()).toBe("oss.cs.fau.de#people");
  });
});

describe("Escape character extravaganza StringArrayName", () => {
  it("test escape and delimiter boundary conditions", () => {
    let n: Name = new StringArrayName(["oss.cs.fau.de"], '#');
    expect(n.getNoComponents()).toBe(1);
    expect(n.asString()).toBe("oss.cs.fau.de");
...
describe("Empty StringName", () => {
  it("test empty string", () => {
    ...
    let n2: Name = n.append("test");
    expect(n.asString()).toBe("");
    expect(n2.asString()).toBe(".test");
  });
});
...
describe("StringArrayName Escape character in whole string", () => {
  it("test escape and delimiter boundary conditions", () => {
    ...
    expect(n.getNoComponents()).toBe(1);
    expect(n.asString()).toBe("Oh...");
    expect(n2.asString()).toBe("Oh....people");
...
describe("StringArrayName Test removing complex component", () => {
  it("append complex component", () => {
    ...
    expect(n2.asDataString()).toBe("fau.de");
  });
});
...
describe("StringArrayName Test Check Empty Append", () => {
  it("append complex component", () => {
    ...
    let n2: Name = n.remove(0);
    expect(n2.isEmpty()).toBe(true);
    let n3: Name = n2.append("5");
    expect(n3.asString()).toBe("5");
...
describe("Clone StringName", () => {
  it("Reconstruct Base Test 1", () => {
    ...
    expect(n2.getNoComponents()).toBe(4);
    expect(n2.asDataString()).toBe("oss/cs/fau/de");
    let n3 = n2.append('tom');
    expect(n3.asString()).toBe("oss/cs/fau/de/tom");
    expect(n3.getNoComponents()).toBe(5);
    expect(n3.asDataString()).toBe("oss/cs/fau/de/tom");
    expect(n2.asString()).toBe("oss/cs/fau/de");
    expect(n2.getNoComponents()).toBe(4);
    expect(n2.asDataString()).toBe("oss/cs/fau/de");
  });
...
describe("StringArrayName Test Empty Display AsString", () => {
  it("test ", async () => {
    ...
    let n2: Name = n.remove(0);
    expect(() => n2.asString()).toThrow(new IllegalArgumentException(m));
  });
});
...
describe("StringArrayName Test Empty Display AsDataString", () => {
  it("test ", async () => {
    ...
    let n: StringArrayName = new StringArrayName(["oss"], '.');
    let n2: Name = n.remove(0);
    expect(() => n2.asDataString()).toThrow(new IllegalArgumentException(m));
  });
});
